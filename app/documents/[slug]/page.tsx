...
export function generateMetadata({ params }: DocumentDetailsPageProps) {
  ...
  if (!document) return { title: 'Dokument nie znaleziony | LexDraft' };
      ...
      <article className="surface-card p-6 sm:p-8">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3">
          ...
          <Link href="/contact" className="btn-secondary">
            Brakuje podobnego dokumentu?
          </Link>
        </div>

        <p className="mt-6 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs leading-5 text-amber-900 dark:border-amber-800 dark:bg-amber-950/40 dark:text-amber-200">
